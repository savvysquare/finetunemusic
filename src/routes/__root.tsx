...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FineTune Music — Edifying Your Music Mind" },
      { name: "description", content: "FineTune Music is a contemporary repertoire band & entertainment organization. Book us for concerts, weddings, ceremonies and live events." },
      { property: "og:title", content: "FineTune Music — Edifying Your Music Mind" },
      { property: "og:description", content: "FineTune Music is a contemporary repertoire band & entertainment organization. Book us for concerts, weddings, ceremonies and live events." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FineTune Music — Edifying Your Music Mind" },
      { name: "twitter:description", content: "FineTune Music is a contemporary repertoire band & entertainment organization. Book us for concerts, weddings, ceremonies and live events." },
